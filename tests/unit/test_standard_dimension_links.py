...
def _assert_certified_baseline_evidence(
...
def test_m10_thread_dimensions_have_governed_evidence() -> None:
    record = resolve_metric_thread_standard("M10x1.5")

    _assert_certified_baseline_evidence(
...
def test_m10_bolt_dimensions_have_governed_evidence() -> None:
...
def test_m10_nut_dimensions_have_governed_evidence() -> None:
